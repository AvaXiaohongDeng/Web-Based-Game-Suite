<?php
/*
Update Tic Tac Toe solution (single file).
*/
...
function play() {
	...
	if(isset($_SESSION['who']))
		$who = $_SESSION['who'];
	if(!isset($who) or isset($_POST['reset'])) {
...
// 		echo $board; 
		...
		if(isset($_POST['curCell'])and ($_POST['curCell']<>$_SESSION['curCell'])) {
			$_SESSION['curCell'] = $_POST['curCell']; //identify which button was submitted 	
			$curPos = $_SESSION['curCell'][0]; // get the actual button clicked. 0 to 8 correspond to respective cell
		...
		$output .= "</table><input type='submit' name='reset' value='Reset' style='height: 30px;' /></form><br>";
		echo $output;
